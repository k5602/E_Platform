...
# E_Platform Unified Nginx Deployment Script
# This script sets up Nginx as a reverse proxy for both Django and Daphne servers

# Exit on error
set -e

echo "E_Platform Unified Nginx Deployment Script"
echo "=========================================="
...
cp "$PROJECT_DIR/nginx/eplatform_unified.conf" "$NGINX_CONF_DIR/eplatform.conf"
...
echo "- Django (Gunicorn): $LOG_DIR/gunicorn-*.log"
echo "- Daphne: $LOG_DIR/daphne-access.log"
