...
urlpatterns = [
    # Main web interface URLs
    path("", views.home_view, name="home"),
    path("post/create/", views.create_post, name="create_post"),
    path("contact/", views.contact_view, name="contact"),
    path("notifications/", views.notifications_view, name="notifications"),
    path("search/", views.user_search_page, name="search_users"),
    # Post interaction URLs (web interface)
    ...
    # Legacy API endpoints (consider migrating to DRF API)
    path(
    ...
    path(
        ...
        views.get_unread_notification_count,
    ...
    path(
        "api/notifications/mark-read/<int:notification_id>/",
        views.mark_notification_read,
